...
parser.add_argument("-t", "--title", help="Title of Engraving")
...
pid = subprocess.call("mkdir /mnt/media/Pictures/Raspi/" + args.title, shell=True)
cmd = ['raspivid', '-vf', '-hf', '-o', '/mnt/media/Pictures/Raspi/' + args.title + '/video.h264', '-t', '999999', '-fps', '10']
popen = Popen(cmd)
...
password = ''
recipient = ''
subject = 'Engraving Finished'
body = 'The engraving has finished.  Please make safe the laser and view your work.  A video and picture of the engraving is located in /mnt/media/Pictures/Raspi/' + args.title + '. '
